...
public class StandardSetHolder extends RecyclerView.ViewHolder implements View.OnClickListener {

    private final ImageView exerciseImageImageView;
    private final TextView exerciseNameTextView;
    private final ImageView exerciseInfoImageView;
    private final TextView scheduleSetsTextView;
    private final TextView scheduleStepRestTimeTextView;

    public StandardSetHolder(View itemView) {
        super(itemView);

        // Init layout elements
        this.exerciseImageImageView = (ImageView) itemView.findViewById(R.id.schedule_step_exercise_image);
        this.exerciseNameTextView = (TextView) itemView.findViewById(R.id.schedule_step_exercise_title_txt);
    ...
    public void bindData(@NonNull final RecyclerViewItem<ScheduleStep> scheduleStepRecyclerViewItem) {
        ...
        this.exerciseInfoImageView.setOnClickListener(this);
        Picasso.get()
