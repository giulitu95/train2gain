...
module.exports = class TrainerInfo extends ApplicationHandlerSkeleton{
    constructor() {
    ...
    processRequest(res, attributes){
        ...
        var self = this;
        userHelper.getTrainerById(attributes.getUserId()).then(function(trainerInfo){
            var httpResponse = new Response(new Date().getTime(), trainerInfo);
